      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ứng dụng chia tiền chi tiêu nhóm du lịch dễ dàng và chính xác. Không
            còn lo lắng về việc tính toán chi phí khi đi du lịch cùng bạn bè.
          </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Hỗ trợ chia đều, chia theo tỷ lệ, chia theo món ăn và nhiều cách
                khác.
              </p>
            </CardContent>
          </Card>
